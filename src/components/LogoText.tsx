...
export default function LogoText({ size = 'large' }: LogoTextProps) {
  ...
  return (
    <div className={`space-y-${size === 'small' ? '1' : '2'}`}>
      <h1 className={`${textSizes[size].main} font-eightgon tracking-wide flex justify-center items-center`}>
      ...
      <h2 className={`${textSizes[size].sub} font-eightgon tracking-wide flex justify-center items-center`}>
