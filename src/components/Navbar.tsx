      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex space-x-4">
            ...
            <Link href="/projects" className={`nav-link ${pathname === '/projects' ? 'bg-medium-blue/20 text-light-gray' : 'text-light-gray/80 hover:text-light-gray hover:bg-medium-blue/10'}`}>
              Projects
            </Link>
